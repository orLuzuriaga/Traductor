...
procedure procedimiento1 (vInt1, vInt2: INTEGER; vReal1: REAL);
...
function funcion1 (vInt1, vInt2: INTEGER; vReal1: REAL): REAL;
...
begin 
  ...
  procedimiento1(( 4 * 5) +  const_Entera, 34, (3 mod 5) div 10 );
